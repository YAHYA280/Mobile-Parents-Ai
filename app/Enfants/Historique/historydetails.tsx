        ...
        <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            >
              ...
              <Text
                style={{ color: dark ? COLORS.secondaryWhite : COLORS.gray3 }}
              >
                {formattedDate}
              </Text>
            </View>
              ...
              >
                {limitedConversation.map((msg, index) => (
                  <View
                    ...
                    style={{
                      marginBottom:
                        index < limitedConversation.length - 1 ? 12 : 0,
                      alignItems:
                ...
                >
                  {activity.exercices.map((ex, index) => (
                    <View
                      ...
                      style={{
                        marginBottom:
                          index < activity.exercices!.length - 1 ? 12 : 0,
                      }}
                    >
                      <View
                        style={{
                ...
                {parentFeedbacks.length > 0 ? (
                  parentFeedbacks.map((fb, index) => (
                    <TouchableOpacity
                      ...
                      style={{
                        marginBottom:
                          index < parentFeedbacks.length - 1 ? 12 : 0,
                      }}
