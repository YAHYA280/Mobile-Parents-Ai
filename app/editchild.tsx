...
const mockChildData = {
  ...
  age: 8,
  grade: 'CE2',
  avatar: images.user7, // Changed from user1 to user7
};
        ...
        <View style={styles.contentContainer}>
          <View style={styles.avatarSection}>
            <View style={styles.avatarContainer}>
              ...
              >
                <Image source={icons.editPencil} style={styles.pickImageIcon} />
              </TouchableOpacity>
            </View>
          </View>
...
interface Styles {
  ...
  // cancelButton removed from static styles
...
const styles = StyleSheet.create<Styles>({
  ...
  // cancelButton removed from here
  saveButton: {
    flex: 1,
    marginLeft: 8,
